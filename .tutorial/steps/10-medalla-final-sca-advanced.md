...
Implementaras este control de SCA de forma concreta sobre el archivo `.github/dependabot.yml` y registraras evidencia tecnica en `.tutorial/evidence/step-10.json`.
...
{
  "step": 10,
  "title": "Medalla final sca advanced",
  "status": "completed",

...
Implementaras este control de SCA de forma concreta sobre el archivo `.github/dependabot.yml` y registraras evidencia tecnica en `.tutorial/evidence/step-04.json`.
...
{
  "step": 4,
  "title": "Auto merge con condiciones estrictas",
  "status": "completed",

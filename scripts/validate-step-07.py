...
STEP = 7
EXPECTED_ARTIFACT = '.github/workflows/dependency-governance.yml'
REQUIRED_MARKERS = ['name: Dependency Governance', 'pull_request:', 'dependency-policy:', 'Check dependency labels']
